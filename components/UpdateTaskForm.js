...
const UpdateTaskForm = ({refetch}) => {
    ...
    return (
        ...
        <label className="leading-7 text-sm text-gray-600">
          ...
          <br />
          <button type="submit" className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white my-3 py-1 px-2 border border-blue-500 hover:border-transparent rounded text-sm mr-2">Update Task</button>
      </form>
            </div>
        </div>
    </div>
